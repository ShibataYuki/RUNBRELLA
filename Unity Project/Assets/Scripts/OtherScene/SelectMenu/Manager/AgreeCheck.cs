...
namespace SelectMenu
{
    public class AgreeCheck : MonoBehaviour
    {
        ...
        /// ステート終了時に行うメソッド
        /// </summary>
        public void AgreeCheckExit(SelectMenuState nextState)
        {
            scalingAnimation.ScalingStop();
            IsAgreeHide();
            if(nextState != SceneController.Instance._selectPlayCountState)
            {
        ...
        /// ステート開始時に行うメソッド
        /// </summary>
        public void AgreeCheckEntry(SelectMenuState beforeState)
        {
            if(beforeState != SceneController.Instance._selectPlayCountState)
            {
